...
docker build --build-arg DEPLOYMENT_ID=${CI_PIPELINE_ID} -t $DOCKER_REGISTRY/$REPO:$PREFIX-$CI_PIPELINE_ID -f test-cases/e2e/dashboard/Dockerfile test-cases/e2e/dashboard
