...
See `e2e/dashboard/frontend/AGENTS.md` for the in-depth frontend guide (theming, shadcn/ui, axios client, auth store, polling/dialog patterns, TS config gotchas).
